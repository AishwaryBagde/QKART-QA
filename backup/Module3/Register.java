...
public class Register {
    ...
    //    wait.until(ExpectedConditions.urlContains("https://crio-qkart-frontend-qa.vercel.app/login"));
        ...
        // wait.until(ExpectedConditions.or(ExpectedConditions.urlContains("//crio-qkart-frontend-qa.vercel.app/login")), 
        //     ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("notistack-snackbar")));

                // wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("confirmPassword"))));
